...
class VirtittaSmokeTests(unittest.TestCase):
    ...
    def test_index_route_renders_annotation_filters_and_optional_groups_column_toggle(self) -> None:
        ...
        self.assertIn('<input type="hidden" name="sort" value="run_name">', rendered)
        self.assertIn('<input type="hidden" name="desc" value="true">', rendered)
        self.assertNotIn('<select name="sort">', rendered)
        self.assertNotIn('Descending', rendered)
